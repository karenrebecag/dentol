    ...
    container.innerHTML = `
      <div class="StickyBar">
        ...
        <div class="ServiciosNavDots">
          <button id="prevServicio" class="NavArrow" type="button">‹</button>
          <span class="dot" data-slide="0"></span>
          <span class="dot" data-slide="1"></span>
          <span class="dot" data-slide="2"></span>
          <span class="dot" data-slide="3"></span>
          <button id="nextServicio" class="NavArrow" type="button">›</button>
        </div>
      </div>
  ...
  function initServiciosComponent(targetId) {
    ...
    function updateActive() {
      ...
      if (activeButton && selector) {
        ...
        const buttonCenter = offsetLeft + activeButton.offsetWidth / 2;
        const containerCenter = selector.offsetWidth / 2;
    
        const newScroll = buttonCenter - containerCenter;
...
<div class="ScrollBullets">
<span class="ScrollBullet" data-step="0"></span>
<span class="ScrollBullet" data-step="1"></span>
<span class="ScrollBullet" data-step="2"></span>
<span class="ScrollBullet" data-step="3"></span>
<span class="ScrollBullet" data-step="4"></span>
<span class="ScrollBullet" data-step="5"></span>
</div>
</div>


<div class="Col50 LeftColServices">
     <div class="SubContainerServices" data-step="3">
  ...
  <div class="SubContainerServices" data-step="4">
...
<div class="NivelContent ">
  ...
  <div class="SubContainerServices" data-step="1">
         ...
         <p class="Paragraph"> 
            Evaluación y seguimiento según cada caso
  ...
  <div class="SubContainerServices" data-step="4">
         <h3 class="HeadingSmall">Raspado y Alisado Radicular Limpieza profunda</h3>
  ...
  <div class="SubContainerServices" data-step="5">
     <h3 class="HeadingSmall">
        Prótesis removibles
     </h3>
...
<div class="Col50 LeftColServices">
     <div class="SubContainerServices" data-step="6">
     ...
     <div div class="SubContainerServices" data-step="7">
     ...
     <div class="SubContainerServices" data-step="8">
    ...
    <div div class="SubContainerServices" data-step="9">
    ...
    <div div class="SubContainerServices" data-step="10">
...
`
      ...
      serviciosContent.innerHTML = nivelesHTML[index];
    ...
    function updateWindow() {
      servicioButtons.forEach((button, index) => {
        if (currentIndex <= 0) {
          button.style.display = (index <= 1) ? 'flex' : 'none';
        } else if (currentIndex >= 1 && currentIndex <= 2) {
          button.style.display = (index >= 1 && index <= 3) ? 'flex' : 'none';
        } else {
    ...
    nextBtn.addEventListener('click', (e) => {
      e.preventDefault();
      if (currentIndex < servicioButtons.length - 1) {
        currentIndex++;
        updateActive();
      }
    });
  ...
  function initScrollIndicator() {
    ...
    const bullets = document.querySelectorAll('.ScrollBullet');
    ...
    function updateScrollLine() {
        ...
        const totalHeight = nivelContent.scrollHeight - windowHeight;
        
        const scrollTop = window.scrollY - nivelContent.offsetTop + 400;
        ...
        bullets.forEach((bullet, index) => {
          const stepProgress = (index + 1) / bullets.length;
          if (scrollProgress >= stepProgress - (1 / bullets.length) / 2) {
